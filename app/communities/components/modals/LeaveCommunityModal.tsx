"use client";
import { leaveCommunity } from "@/services/community/communityServices";
import {
  Dialog,
  DialogPanel,
  DialogTitle,
...
export default function LeaveCommunityModal({
  ...
  const handleDelete = async () => {
    ...
    setIsDeleting(true);
    try {
      await leaveCommunity(communityId as unknown as number);
      setIsDeleting(false);
      setIsDeleted(true);
                ...
                {!isDeleted ? (
                  <>
                    <Description className="text-gray-600 text-sm leading-relaxed mb-5 text-center">
                      ...
                      pero ya no podrás participar dentro de la comunidad:
                    </Description>
                ...
                {!isDeleted ? (
                  <>
                    ...
                    <button
                      ...
                      `}
                    >
                      {isDeleting ? "Eliminando..." : "Salir de la comunidad"}
                    </button>
                  </>
                ) : (
                  <button
